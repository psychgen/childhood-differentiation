# 04.2_specify_combined_LGMs_with_predictors.R

### steps followed for the combined diff + tot LGMs:

# 1. specify LGM with effects on both growth factors
# 2. specify LGM with effects on intercept only
# 3. specify LGM with effects on slope only
...
# time-invariant covariates (intercept & (co)variance)
...
# predictors (effects)
           ...
           i1 + s1 ~ distress_m + pre_distress_m + pre_distress_f + pre_stress_m + 
           ...
           i2 + s2 ~ distress_m + pre_distress_m + pre_distress_f + pre_stress_m + 
                     post_stress_m + stress_f + post_dep_m + relation_m + relation_f +
                     education + income + smoking_m + smoking_f + 
                     alc_risk_tot_m + alc_risk_tot_f + alc_prob_m
...
# both: LGM with covariates and predictors, intercepts only ####
...
# predictors (effects)
           ...
           i1 + 0*s1 ~ distress_m + pre_distress_m + pre_distress_f + pre_stress_m + 
                       post_stress_m + stress_f + post_dep_m + relation_m + relation_f +
                       education + income + smoking_m + smoking_f + 
                       alc_risk_tot_m + alc_risk_tot_f + alc_prob_m
           i2 + 0*s2 ~ distress_m + pre_distress_m + pre_distress_f + pre_stress_m + 
                       post_stress_m + stress_f + post_dep_m + relation_m + relation_f +
                       education + income + smoking_m + smoking_f + 
                       alc_risk_tot_m + alc_risk_tot_f + alc_prob_m
...
# both: LGM with covariates and predictors, slopes only ####
...
# predictors (effects)
           ...
           0*i1 + s1 ~ distress_m + pre_distress_m + pre_distress_f + pre_stress_m + 
                       post_stress_m + stress_f + post_dep_m + relation_m + relation_f +
                       education + income + smoking_m + smoking_f + 
                       alc_risk_tot_m + alc_risk_tot_f + alc_prob_m
           0*i2 + s2 ~ distress_m + pre_distress_m + pre_distress_f + pre_stress_m + 
                       post_stress_m + stress_f + post_dep_m + relation_m + relation_f +
                       education + income + smoking_m + smoking_f + 
                       alc_risk_tot_m + alc_risk_tot_f + alc_prob_m
