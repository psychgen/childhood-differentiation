# 04.1_specify_LGMs_with_predictors.R
...
### PS. note that we run models with a modified
# at-risk drinking score, but the original model
# with continuous drinking is provided for context
  

# diff: LGM with covariates and predictors, with continuous drinking ####
...
# predictors (effects)
           ...
           i + s ~ distress_m + pre_distress_m + pre_distress_f + pre_stress_m + 
                   ...
                   alc_freq_m_tot + alc_no_m_tot + alc_prob_m
...
# predictors (intercept & variance)
           ...
           smoking_m ~~ smoking_m
           smoking_f ~~ smoking_f
           alc_freq_m_tot ~~ alc_freq_m_tot
           alc_no_m_tot ~~ alc_no_m_tot
           alc_use_f ~~ alc_use_f
...
# covariances
           ...
           distress_m ~~ alc_freq_m_tot
           distress_m ~~ alc_no_m_tot
           distress_m ~~ alc_use_f
           ...
           pre_distress_m ~~ alc_freq_m_tot
           pre_distress_m ~~ alc_no_m_tot
           pre_distress_m ~~ alc_use_f
           ...
           pre_distress_f ~~ alc_freq_m_tot
           pre_distress_f ~~ alc_no_m_tot
           pre_distress_f ~~ alc_use_f
           ...
           pre_stress_m ~~ alc_freq_m_tot
           pre_stress_m ~~ alc_no_m_tot
           pre_stress_m ~~ alc_use_f
           ...
           post_stress_m ~~ alc_freq_m_tot
           post_stress_m ~~ alc_no_m_tot
           post_stress_m ~~ alc_use_f
           ...
           stress_f ~~ smoking_m
           stress_f ~~ smoking_f
           stress_f ~~ alc_freq_m_tot
           stress_f ~~ alc_no_m_tot
           stress_f ~~ alc_use_f
           stress_f ~~ alc_prob_m
           ...
           post_dep_m ~~ alc_freq_m_tot
           post_dep_m ~~ alc_no_m_tot
           post_dep_m ~~ alc_use_f
           ...
           relation_m ~~ alc_freq_m_tot
           relation_m ~~ alc_no_m_tot
           relation_m ~~ alc_use_f
           relation_m ~~ alc_prob_m
           relation_f ~~ education
           relation_f ~~ income
           relation_f ~~ smoking_m
           relation_f ~~ smoking_f
           relation_f ~~ alc_freq_m_tot
           relation_f ~~ alc_no_m_tot
           relation_f ~~ alc_use_f
           relation_f ~~ alc_prob_m
           education ~~ income
           education ~~ smoking_m
           education ~~ smoking_f
           education ~~ alc_freq_m_tot
           education ~~ alc_no_m_tot
           education ~~ alc_use_f
           education ~~ alc_prob_m
           income ~~ smoking_m
           income ~~ smoking_f
           income ~~ alc_freq_m_tot
           income ~~ alc_no_m_tot
           income ~~ alc_use_f
           income ~~ alc_prob_m
           smoking_m ~~ smoking_f
           smoking_m ~~ alc_freq_m_tot
           smoking_m ~~ alc_no_m_tot
           smoking_m ~~ alc_use_f
           smoking_m ~~ alc_prob_m
           smoking_f ~~ alc_freq_m_tot
           smoking_f ~~ alc_no_m_tot
           smoking_f ~~ alc_use_f
           smoking_f ~~ alc_prob_m
           alc_freq_m_tot ~~ alc_no_m_tot
           alc_freq_m_tot ~~ alc_use_f
           alc_freq_m_tot ~~ alc_prob_m
           alc_no_m_tot ~~ alc_use_f
           alc_no_m_tot ~~ alc_prob_m
           alc_use_f ~~ alc_prob_m
           '
  
  
# diff: LGM with covariates and predictors, with at-risk drinking ####
...
# diff: LGM with covariates and predictors, intercept only, at-risk drinking ####
...
# diff: LGM with covariates and predictors, slope only, with at-risk drinking ####
...
# tot: LGM with covariates and predictors, continuous drinking ####
...
# predictors (effects)
          ...
          i ~ distress_m + pre_distress_m + pre_distress_f + pre_stress_m + 
              post_stress_m + stress_f + post_dep_m + relation_m + relation_f +
              education + income + smoking_m + smoking_f + 
              alc_use_m + alc_use_f + alc_prob_m
          s ~ distress_m + pre_distress_m + pre_distress_f + pre_stress_m + 
              post_stress_m + stress_f + post_dep_m + relation_m + relation_f +
              education + income + smoking_m + smoking_f + 
              alc_use_m + alc_use_f + alc_prob_m
...
# covariances
          ...
          smoking_f ~~ alc_prob_m
          alc_use_m ~~ alc_use_f
          alc_use_m ~~ alc_prob_m
          alc_use_f ~~ alc_prob_m
          '
  
# tot: LGM with covariates and predictors, with at-risk drinking ####
...
# tot: LGM with covariates and predictors, intercept only, at-risk drinking ####
...
# tot: LGM with covariates and predictors, slope only, with at-risk drinking ####
