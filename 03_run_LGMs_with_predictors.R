# 03_run_LGMs_with_predictors.R

# this script runs the latent growth models (LGMs) including 'environmental' 
# predictors by sourcing: 03.1_specify_LGMs_with_predictors.R
...
# specify LGMs
  source("./scripts/03.1_specify_LGMs_with_predictors.R")

# diff: run  LGMs and compare ####
  
# diff: run LGM with predictors on intercept and slope
...
# diff: run  LGM with predictors on intercept only
...
# diff: run  LGM with predictors on slope only
...
# tot: run modified LGM with predictors on intercept and slope
...
# tot: run  LGM with predictors on intercept only
...
# tot: run  LGM with predictors on slope only
